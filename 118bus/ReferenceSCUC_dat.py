...
##########################################################
model.AllGenerators = Set()
model.ThermalGenerators = Set()
model.NonThermalGenerators = Set()
model.RenewableGenerators = Set()
model.HydroGenerators = Set()
model.WindGenerators = Set()
...
model.BlockSize = Param(model.ThermalGenerators, model.Blocks)
##########################################################
# string indentifiers for the set of thermal generators buses. #
##########################################################

model.GenBuses = Param(model.AllGenerators)
...
model.LineLimits = Param(model.Branches, within=NonNegativeReals)
...
model.BusDemand = Param(model.LoadBuses, model.TimePeriods, within=NonNegativeReals)

# Power forecasts

model.PowerForecast = Param(model.NonThermalGenerators, model.TimePeriods, within=NonNegativeReals)
...
model.MinimumUpTime = Param(model.ThermalGenerators, within=NonNegativeIntegers, mutable=True)
model.MinimumDownTime = Param(model.ThermalGenerators, within=NonNegativeIntegers, mutable=True)
...
model.PowerGeneratedT0 = Param(model.AllGenerators, within=NonNegativeReals)
...
model.BlockMarginalCost = Param(model.ThermalGenerators, model.Blocks, within=NonNegativeReals)
...
model.ShutdownCostCoefficient = Param(model.ThermalGenerators, within=NonNegativeReals) # units are $.

model.StartupCostCoefficient = Param(model.ThermalGenerators, within=NonNegativeReals) # units are $.
